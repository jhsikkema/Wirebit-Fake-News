...
analyze_text_parser.add_argument('author',	help = 'This field cannot be blank', required = True)
analyze_text_parser.add_argument('publisher',	help = 'This field cannot be blank', required = True)
analyze_text_parser.add_argument('platform',	help = 'This field cannot be blank', required = True)
analyze_text_parser.add_argument('title',	help = 'This field cannot be blank', required = True)
analyze_text_parser.add_argument('content',	help = 'This field cannot be blank', required = True)
